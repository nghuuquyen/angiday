...
module.exports = async function downLoadListUserRelated(req, res) {
  ...
  res.setHeader('Content-Disposition', 'attachment; filename=\"' + 'campagin-member-list' + Date.now() + '.csv\"');

  return stringify(users, { header: true }).pipe(res);
}
